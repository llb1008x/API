...
2017.7.27
	1.电池曲线的导入和fuelgauge3.0客制化										*****			  70%
	2.G1605A的电量跳变问题													   ****				 0%
	3.在其位谋其事															***				  100%
	4.管理好自己的情绪，养成良好的生活习惯，每天要有进步							   ***				 100%
...
2017.7.31
	1.17G10A USB添加uid，pid												  *****			   80%	
	2.G1605A的电量跳变问题													    ****			 0%
	3.电池曲线的客制化														   ****				100%
	4.调整生活节奏，当前需要做哪些事，怎么更好的完成这些事							***				80%




/********************************************************************************************************/
这个习惯要坚持下去，有很多事情太乱，没有一个重心，不知道做什么，所以每天需要一些合理的规划，
坚持列计划，每天都要检查任务完成的情况，每周都要对着周的情况做一定的评估，哪些做的好，哪些做的不好


2017.8.6
	1.今天最主要的任务是G1605A的电量跳变问题，合理的分析解决方案，处理完这个问题		 *****			 30%
    2.对以前处理的问题归类到buglist，现象，分析，结论，值得注意的地方				 ****			 50%
	3.逐步调整自己的生活节奏，生活状态，每天坚持运动								 ***			80%
	4.倒计时，按照自己的计划，建立知识体系，一步一步去完善						   ***			   90%


2017.8.7
	1.G1605A的电量跳变问题														*****		  100%
	2.文档归类，列出一些计划要看的，每天看几个文档，多积累一点						  ****			20%
	3.调整生活状态，多运动，保持好的身体机能										***			  80%
	4.养成一定的学习习惯，每天坚持学习											  ***			80%


2017.8.9
	1.调试17G06A，先做一点checklist，看看有哪些问题							   *****		 20%
	2.熟悉高通的代码跟文档													  ****			0%
	3.调整心态，调整生活节奏，寻找最佳的生活状态										***			 80%
	4.养成良好的学习习惯，坚持每天学习，进步，积累								  ***			80%

2017.8.10
	1.先处理完17G06A的过压无截止电流											 *****		   0%
	2.17G10A在meta模式下的端口识别问题											  ****			0%
	3.控制自己的情绪，调整心态，不然很有问题										 ***		   20%
	4.坚持每天学习，坚持运动													  ***			20%


2017.8.11
	1.17G06A的diag口跟不识别跟adb端口被占用										  *****		   0%
	2.今天最主要的任务就是处理完上面的两个任务										 ****		  0%
	3.控制自己的情绪，调整自己的心态												***			 50%
	4.坚持运动，坚持学习														    ***			 0%
...
2017.8.12
	1.17G10A，meta模式下的USB的vid，pid问题										*****		100%
	2.17G06A的diag不识别问题，adb，diag口兼容问题								  ****		  0%
	3.思考问题要谨慎，细致，做事要走心												****		80%
	4.坚持每天必要的运动，坚持学习												 ***		 0%


2017.8.14
	1.17G06A的diag口跟adb公用问题												 *****		 0%
	2.改掉坏习惯，专心做好每一步													 ****		 100%
	3.坚持运动，坚持学习															***			100%
...
2017.8.19
	1.17G10A的温升问题，基本的策略要实现											 *****		80%
	2.高通USB相关的文档，代码，只有熟悉框架，结构才能对症下药							 ****		0%	
	3.坚持运动，坚持学习，很多事需要坚持，坚持下来才能达到自己预期的					  ***		 90%
	4.调节自己的心态，控制自己的情绪												 ***		80%



2017.8.21
	1.17G10A的充电温升问题，完善解决的方案，优化处理策略								*****	   90%
	2.高通USB文档 customize，今天计划看到100页									   ****		  10%
	3.坚持运动，坚持学习，多活几年，未来的路更好走一点								   ***		  80%
	4.调节自己的心态，控制自己的情绪												 ***		80%



2017.8.22
	1.17G06A USB相关的内容，USB眼图，LDO供电，diag口打开失败							*****	  50%
	2.高通USB相关的文档，20业，高通的熟悉程度跟文档的熟悉程度有很大关系					****	  80%
	3.坚持运动，坚持学习，不让自己后悔，这个时候该努力									***		  80%
	4.情绪，心态，情商，没救了														***		  80%



2017.8.23
	1.17G10A的相关BUG，先处理完													  *****		  0%
	2.17G06A，高通USB相关的内容，看相关文档，有一个整体认知，列好计划					  ****		 0%
	3.坚持运动，坚持学习，劳逸结合												   ***		  20%
	4.做自己该做的事，提高自己的水平												  ***		 20%
...
2017.9.5
	1.整理下文档，还有哪些BUG，哪些要处理的问题									   ****		   20%
	2.17G10A关机充电问题，17G06A关机充电好像还有跳变现象							   ****		   20%
	3.高通的USB文档，现在先把这片文档看完，还有DDR3关于USB这块的内容					  ***		  20%
	4.工作中要保持一个好的情绪，好的心态，最终都是为了解决问题，不要多想					  ***		  60%
	5.锻炼身体，保持个人卫生，多想，敢思考，敢去做									 ***		 80%


2017.9.6
	1.17G06A的待机电流问题，自己抓的log自己也要看看，需要做什么自己留点心，同时也要看看文档	*****     60%
	2.整理好相应的文档，跟自己的buglist，有总结，有收获						     	    ****	 0%
	3.高通USB相关的文档，坚持每天看，经常看，反复看									    ***		 20%
	4.保持好的心态跟情绪，每天坚持锻炼身体											  ***	   80%


2017.9.7
	1.17G06A的电流问题，整理一下思路，自己多分析分析								  *****
	2.17G10A的温升问题，可能今天只能编译一个版本了									   ****
	3.工作正的好乱，好多事情都没有处理好，静下心										  ***
	4.坚持看文档，坚持锻炼，心态要正常												 ***
