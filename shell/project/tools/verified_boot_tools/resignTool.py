...
def setPath():
	...
	if(pwd_split[0].find("resignTool.py") != -1):
		pwd ="../"
	...
	cert_gen_path =  "gionee/config/tools/verified_boot_tools/configs/"
	cert_tool = "gionee/config/tools/verified_boot_tools/cert_gen.py"
	mkimage_path 	= 	"gionee/config/tools/verified_boot_tools/mkimage"
	mkimage_config 	= 	"gionee/config/tools/verified_boot_tools/configs/img_hdr.cfg"
	#mdGfhParser_path = "vendor/mediatek/proprietary/scripts/sign-image_v2/mdtool/getPublicKey"
	mdGfhParser_path = "gionee/config/tools/verified_boot_tools/getPublicKey"
	...
	if(argDict['type'] =="cert1md" ):
		...
		cert1_name 				= 	out_path + "cert/cert1/{}_cert1.der".format(img_name)
