...
extern kal_bool is_enter_mmi_test;
//#endif
extern unsigned int g_gn_screenon_time;
//Gionee GuoJianqiu 20150514 modify for GNNCR00010646 end

//Gionee GuoJianqiu 201601026 modify for OTG SWITCH begin
#define GN_BATTERY_OTGCHARGE_SWITCH_SUPPORT
#if defined(GN_BATTERY_OTGCHARGE_SWITCH_SUPPORT)
extern void gn_Open_Otg_Irq(void);
extern void gn_Close_Otg_Irq(void);
#endif
...
extern int gn_switch_charging_state;
extern int gn_switch_charging_down;
extern int gn_switch_charging_up;
