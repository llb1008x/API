...
.btn_my_zzk:hover { background:#08C;}

/* 链接 */
.catListTag {overflow:auto;}
.catListTag li {
float:left;
float:none\9;
...
.catListArticleCategory{overflow:auto;}
.catListArticleCategory li {
...
.catListPostCategory{overflow:auto;}
...
.postBody blockquote 
{
	background: url("http://common.cnblogs.com/Skins/iMetro_HD/images/quote.png") no-repeat -75px -20px #efefef;
	border:solid thin;
	margin: 5px 0px;
