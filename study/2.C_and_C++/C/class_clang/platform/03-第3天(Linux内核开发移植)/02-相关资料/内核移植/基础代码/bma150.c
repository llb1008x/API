...
static long bma150_device_ioctl( struct file*, unsigned int, unsigned long );
...
static long bma150_device_ioctl(struct file* file, unsigned int cmd, unsigned long arg)
{
